...
import transport.command.clase.Autobuz;
import transport.command.clase.Automobil;
import transport.command.clase.CommandPlecareInCursa;
import transport.command.clase.ManagerComenzi;
